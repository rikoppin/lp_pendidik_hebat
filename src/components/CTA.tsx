        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="space-y-8">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
              ...
              <br />
              <span className="text-yellow-400">Serupa di Masa Depan?</span>
            </h2>

            {/* Description */}
            <div className="space-y-6">
              <p className="text-xl md:text-2xl text-white/90 leading-relaxed max-w-4xl mx-auto">
                Pelatihan "Menjadi Pendidik Hebat Sedekat Sahabat" telah sukses terlaksana dengan 
                antusiasme luar biasa dari 100+ peserta. Kami akan terus menghadirkan pelatihan 
                berkualitas untuk pengembangan para pendidik dan pengasuh.
              </p>
              <p className="text-lg md:text-xl text-yellow-300 leading-relaxed max-w-4xl mx-auto font-medium">
                Hubungi kami untuk informasi mengenai pelatihan mendatang dan jadilah yang pertama 
                mengetahui program-program inspiratif kami selanjutnya!
              </p>
            </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                <div className="flex items-center justify-center space-x-3 text-center">
                  ...
                  <div className="text-left">
                    <h4 className="text-lg font-bold text-white mb-1">Ingin Tahu Program Berikutnya?</h4>
                    <p className="text-white/80">Tim kami siap memberikan informasi tentang pelatihan mendatang. Hubungi kami melalui WhatsApp untuk mendapatkan update terbaru.</p>
                  </div>
                </div>
              </div>
            </div>
