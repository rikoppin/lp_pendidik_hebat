        ...
        <svg className="w-full h-full" viewBox="0 0 100 100" fill="none">
          <defs>
            <pattern id="cta-pattern" width="30" height="30" patternUnits="userSpaceOnUse">
              ...
              <circle cx="5" cy="5" r="1" fill="currentColor" className="text-yellow-300"/>
              <circle cx="25" cy="25" r="1" fill="currentColor" className="text-yellow-300"/>
            </pattern>
          </defs>
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="space-y-8">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
              ...
              <br />
              <span className="text-yellow-300">Transformasi Anda</span>
            </h2>
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg md:text-xl text-yellow-200 leading-relaxed max-w-4xl mx-auto font-medium">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center pt-8">
              {/* Primary Button */}
              <button className="group relative px-10 py-5 bg-yellow-300 text-gray-900 font-bold text-xl rounded-full hover:bg-yellow-400 transition-all duration-300 transform hover:scale-105 shadow-2xl hover:shadow-yellow-300/25">
                <span className="relative z-10">Daftar Sekarang</span>
                <div className="absolute inset-0 bg-gradient-to-r from-yellow-200 to-yellow-400 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              </button>

              {/* Secondary Button */}
              <button className="group relative px-10 py-5 border-2 border-white text-white font-bold text-xl rounded-full hover:bg-white hover:text-gray-900 transition-all duration-300 transform hover:scale-105 shadow-xl flex items-center space-x-3">
