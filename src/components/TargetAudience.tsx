...
const TargetAudience: React.FC = () => {
  return (
    <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden">
        ...
        <svg className="w-full h-full" viewBox="0 0 80 80" fill="none">
          <defs>
            <pattern id="target-pattern" width="40" height="40" patternUnits="userSpaceOnUse">
              ...
              <path d="M10 10l20 20M30 10l-20 20" stroke="currentColor" strokeWidth="0.5" className="text-purple-400"/>
            </pattern>
          </defs>
      ...
      {/* Floating Elements */}
      <div className="absolute top-16 right-16 w-20 h-20 bg-blue-400/10 rounded-full blur-lg animate-pulse"></div>
      <div className="absolute bottom-16 left-16 w-24 h-24 bg-purple-400/10 rounded-full blur-lg animate-pulse delay-1000"></div>
          ...
          <div className="mt-16 text-center">
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-8 md:p-12 text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <button className="border-2 border-white text-white hover:bg-white hover:text-blue-600 font-bold py-4 px-8 rounded-full transition-all duration-300">
                  Konsultasi Gratis
                </button>
              </div>
            </div>
